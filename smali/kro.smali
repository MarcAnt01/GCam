...
.method protected final a(Lkyn;Lksa;Ljava/util/List;Landroid/hardware/camera2/params/InputConfiguration;Landroid/os/Handler;)V
    ...
    :try_start_1
    invoke-interface {p1, v1, p2, p5}, Lkyn;->a(Ljava/util/List;Lkyl;Landroid/os/Handler;)V

    goto :goto_1

    :cond_1
    invoke-interface {p1, p4, v1, p2, p5}, Lkyn;->a(Landroid/hardware/camera2/params/InputConfiguration;Ljava/util/List;Lkyl;Landroid/os/Handler;)V
    :try_end_1
