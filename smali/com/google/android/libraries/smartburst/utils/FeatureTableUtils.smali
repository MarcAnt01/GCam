...
.method public static getAllValidFeatureValue(Lcom/google/android/libraries/smartburst/buffers/FeatureTable;Lloz;)Lcom/google/android/libraries/smartburst/utils/FloatArray;
    .locals 4
    ...
    invoke-interface {p0, v2, v3}, Lcom/google/android/libraries/smartburst/buffers/FeatureTable;->getRowIterator(J)Lloh;

    move-result-object v2

    :goto_0
    invoke-interface {v2}, Lloh;->a()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-interface {v2}, Lloh;->next()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Llog;

    invoke-interface {v0}, Llog;->a()Lcom/google/android/libraries/smartburst/utils/Feature;
...
.method public static getAllValidTimestamps(Lcom/google/android/libraries/smartburst/buffers/FeatureTable;)[J
    ...
    :cond_0
    invoke-static {v1}, Lnem;->a(Ljava/util/Collection;)[J
...
.method public static getFeatureInRange(Lcom/google/android/libraries/smartburst/buffers/FeatureTable;Lloz;JJ)Lcom/google/android/libraries/smartburst/utils/FloatArray;
    .locals 6
    ...
    invoke-interface {p0, p2, p3}, Lcom/google/android/libraries/smartburst/buffers/FeatureTable;->getRowIterator(J)Lloh;
...
.method public static getTimestampsInRange(Lcom/google/android/libraries/smartburst/buffers/FeatureTable;JJ)Ljava/util/List;
    ...
    invoke-interface {p0, p1, p2}, Lcom/google/android/libraries/smartburst/buffers/FeatureTable;->getRowIterator(J)Lloh;
