...
.method public static createFrom(Lcom/google/android/libraries/smartburst/buffers/FeatureTable;JJ)Lcom/google/android/libraries/smartburst/filterpacks/motion/MotionStabilizer;
    ...
    invoke-interface {p0, v4, v5}, Lcom/google/android/libraries/smartburst/buffers/FeatureTable;->getRowIterator(J)Lloh;
    ...
    :cond_0
    :goto_1
    invoke-interface {v4}, Lloh;->a()Z

    move-result v0

    if-eqz v0, :cond_3

    invoke-interface {v4}, Lloh;->next()Ljava/lang/Object;
    ...
    invoke-interface {p0, v6, v7, v2}, Lcom/google/android/libraries/smartburst/buffers/FeatureTable;->getFeature(JLloz;)Lcom/google/android/libraries/smartburst/utils/Feature;
