...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lin;->b:Ljy;

    new-instance v0, Lip;

    invoke-direct {v0}, Lip;-><init>()V

    sput-object v0, Lin;->e:Ljava/util/Comparator;

    return-void
.end method

.method public static a(Landroid/content/Context;Lim;Lhx;Landroid/os/Handler;ZII)Landroid/graphics/Typeface;
    .locals 6
    ...
    iget-object v1, p1, Lim;->b:Ljava/lang/String;
    ...
    invoke-direct {v4, p0, p1, p6, v3}, Lio;-><init>(Landroid/content/Context;Lim;ILjava/lang/String;)V

    if-eqz p4, :cond_1

    :try_start_0
    sget-object v0, Lin;->d:Lir;
    ...
    invoke-direct {v0, p2, p3}, Lro;-><init>(Lhx;Landroid/os/Handler;)V

    move-object v1, v0

    :goto_1
    sget-object v5, Lin;->a:Ljava/lang/Object;
    ...
    invoke-static {p0, p1, p6}, Lin;->a(Landroid/content/Context;Lim;I)Liq;
    ...
    invoke-virtual {p2, v1, p3}, Lhx;->a(Landroid/graphics/Typeface;Landroid/os/Handler;)V
    ...
    :cond_8
    invoke-virtual {p2, v1, p3}, Lhx;->a(ILandroid/os/Handler;)V
    ...
    invoke-virtual {p2, v0}, Lhx;->a(Landroid/graphics/Typeface;)V
...
.method static a(Landroid/content/Context;Lim;I)Liq;
    .locals 12
    ...
    iget-object v2, p1, Lim;->c:Ljava/lang/String;
    ...
    iget-object v8, p1, Lim;->d:Ljava/lang/String;
    ...
    iget-object v2, p1, Lim;->d:Ljava/lang/String;
    ...
    :cond_2
    sget-object v0, Lin;->e:Ljava/util/Comparator;
    ...
    invoke-direct {v0, v1, v2}, Lrq;-><init>(I[Lvv;)V
    :try_end_1
    ...
    iget-object v0, v0, Lrq;->a:[Lvv;

    sget-object v1, Lib;->b:Lnw;

    invoke-virtual {v1, p0, v0, p2}, Lnw;->a(Landroid/content/Context;[Lvv;I)Landroid/graphics/Typeface;
    ...
    invoke-static {p0, p1, v0}, Lin;->a(Landroid/content/Context;Lim;Ljava/lang/String;)[Lvv;
    ...
    invoke-direct {v0, v2, v1}, Lrq;-><init>(I[Lvv;)V
    :try_end_2
...
.method public static a(Landroid/content/Context;[Lvv;Landroid/os/CancellationSignal;)Ljava/util/Map;
    .locals 5
    ...
    :cond_1
    iget-object v3, v3, Lvv;->d:Landroid/net/Uri;
    ...
    invoke-static {p0, v4, v3}, Lnw;->a(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;
...
.method private static a(Landroid/content/Context;Lim;Ljava/lang/String;)[Lvv;
    .locals 19
    ...
    iget-object v7, v0, Lim;->e:Ljava/lang/String;
    ...
    invoke-direct/range {v4 .. v9}, Lvv;-><init>(Landroid/net/Uri;IIZI)V
